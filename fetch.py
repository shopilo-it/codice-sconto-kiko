#!/usr/bin/env python3
"""
Recupero codici sconto KIKO Milano da shopilo.it
Sursa: https://shopilo.it/negozi/kikocosmetics.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/kikocosmetics.com"
STORE_NAME = "KIKO Milano"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per KIKO Milano da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-kiko)"
    }
    try:
