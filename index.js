 ...
 * Homepage: https://shopilo.it/negozi/kikocosmetics.com
 */

const SHOPILO_URL = "https://shopilo.it/negozi/kikocosmetics.com";
const STORE_NAME  = "KIKO Milano";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-kiko)" }
  });
